...
`The Unreasonable Ineffectiveness of the Deeper Layers <https://arxiv.org/pdf/2403.17887.pdf>`_
    From Meta (and others).  Investigates pruning LLMs and finds you can pruen up to half(!) of layers without much degradation in performance.  Seems crazy, but we should maybe try this if it holds up. 

...
`URBANWORLD: AN URBAN WORLD MODEL FOR 3D CITY GENERATION <https://arxiv.org/pdf/2407.11965>`_
    Generates a digital rendering of a city from an Open Street Map prompt.  Could be useful for building out 3D world-space objects.
